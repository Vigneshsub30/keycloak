# Keycloak Admin REST API MCP Server

This MCP (Model Content Protocol) server provides access to Keycloak Admin REST API API functionality through HTTP, HTTPS, and STDIO transport modes.
