...
class Get_Realm_Users_Id_GroupsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Realm_Users_Id_GroupsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("briefRepresentation")) {
            queryParams.add("briefRepresentation=" + args.get("briefRepresentation"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_realm_users_id_groups" + queryString;
    ...
    public static MCPServer.Tool createGet_Realm_Users_Id_GroupsTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_Realm_Users_Id_GroupsHandler(config));
    }
