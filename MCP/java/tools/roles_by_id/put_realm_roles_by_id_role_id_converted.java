/**
 * MCP Server function for Update the role
 */
...
class Put_Realm_Roles_By_Id_Role_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_Realm_Roles_By_Id_Role_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("composites")) {
            queryParams.add("composites=" + args.get("composites"));
                ...
                String url = config.getBaseUrl() + "/api/v2/put_realm_roles_by_id_role_id" + queryString;
    ...
    public static MCPServer.Tool createPut_Realm_Roles_By_Id_Role_IdTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "put_realm_roles_by_id_role_id",
            "Update the role",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPut_Realm_Roles_By_Id_Role_IdHandler(config));
    }
