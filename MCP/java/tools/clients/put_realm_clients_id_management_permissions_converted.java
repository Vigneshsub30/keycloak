...
class Put_Realm_Clients_Id_Management_PermissionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_Realm_Clients_Id_Management_PermissionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("scopePermissions")) {
            queryParams.add("scopePermissions=" + args.get("scopePermissions"));
                ...
                String url = config.getBaseUrl() + "/api/v2/put_realm_clients_id_management_permissions" + queryString;
    ...
    public static MCPServer.Tool createPut_Realm_Clients_Id_Management_PermissionsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "put_realm_clients_id_management_permissions",
            "Return object stating whether client Authorization permissions have been initialized or not and a reference",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPut_Realm_Clients_Id_Management_PermissionsHandler(config));
    }
