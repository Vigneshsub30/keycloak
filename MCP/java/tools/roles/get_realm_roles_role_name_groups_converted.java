...
class Get_Realm_Roles_Role_Name_GroupsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Realm_Roles_Role_Name_GroupsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("briefRepresentation")) {
            queryParams.add("briefRepresentation=" + args.get("briefRepresentation"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_realm_roles_role_name_groups" + queryString;
    ...
    public static MCPServer.Tool createGet_Realm_Roles_Role_Name_GroupsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_realm_roles_role_name_groups",
            "Return List of Groups that have the specified role name",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Realm_Roles_Role_Name_GroupsHandler(config));
    }
