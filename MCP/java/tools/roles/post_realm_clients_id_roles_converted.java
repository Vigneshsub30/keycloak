/**
 * MCP Server function for Create a new role for the realm or client
 */
...
class Post_Realm_Clients_Id_RolesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Realm_Clients_Id_RolesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("composites")) {
            queryParams.add("composites=" + args.get("composites"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_realm_clients_id_roles" + queryString;
    ...
    public static MCPServer.Tool createPost_Realm_Clients_Id_RolesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_realm_clients_id_roles",
            "Create a new role for the realm or client",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Realm_Clients_Id_RolesHandler(config));
    }
