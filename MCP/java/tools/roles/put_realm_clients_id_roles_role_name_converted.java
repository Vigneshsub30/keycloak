...
class Put_Realm_Clients_Id_Roles_Role_NameMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_Realm_Clients_Id_Roles_Role_NameHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("composites")) {
            queryParams.add("composites=" + args.get("composites"));
                ...
                String url = config.getBaseUrl() + "/api/v2/put_realm_clients_id_roles_role_name" + queryString;
    ...
    public static MCPServer.Tool createPut_Realm_Clients_Id_Roles_Role_NameTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "put_realm_clients_id_roles_role_name",
            "Update a role by name",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPut_Realm_Clients_Id_Roles_Role_NameHandler(config));
    }
