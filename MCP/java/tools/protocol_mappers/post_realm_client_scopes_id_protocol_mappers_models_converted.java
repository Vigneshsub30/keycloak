...
class Post_Realm_Client_Scopes_Id_Protocol_Mappers_ModelsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Realm_Client_Scopes_Id_Protocol_Mappers_ModelsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("config")) {
            queryParams.add("config=" + args.get("config"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_realm_client_scopes_id_protocol_mappers_models" + queryString;
    ...
    public static MCPServer.Tool createPost_Realm_Client_Scopes_Id_Protocol_Mappers_ModelsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_realm_client_scopes_id_protocol_mappers_models",
            "Create a mapper",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Realm_Client_Scopes_Id_Protocol_Mappers_ModelsHandler(config));
    }
