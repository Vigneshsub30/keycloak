...
class Put_Realm_Clients_Id1_Protocol_Mappers_Models_Id2MCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_Realm_Clients_Id1_Protocol_Mappers_Models_Id2Handler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("config")) {
            queryParams.add("config=" + args.get("config"));
                ...
                String url = config.getBaseUrl() + "/api/v2/put_realm_clients_id1_protocol_mappers_models_id2" + queryString;
    ...
    public static MCPServer.Tool createPut_Realm_Clients_Id1_Protocol_Mappers_Models_Id2Tool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "put_realm_clients_id1_protocol_mappers_models_id2",
            "Update the mapper",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPut_Realm_Clients_Id1_Protocol_Mappers_Models_Id2Handler(config));
    }
